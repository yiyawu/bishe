...
Component({
  ...
  methods: {
    ...
    requestSigServer: function (userSig, privMapEncrypt) {
      ...
      url += '?sdkappid=' + sdkAppID + "&identifier=" + userID + "&usersig=" + userSig + "&contenttype=json";
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          //获取推流地址和播放地址
          app.func.getJson('weixinGetPushurl', {
            roomId: roomID,
            userId: userID
          }, (res) => {
            console.log(res)
            self.setData({
              ...
              accelerateURL: res.data.playUrl.urlPlayRtmp
            })
            console.log(self.data.pushURL)
            console.log(self.data.accelerateURL)
          })
